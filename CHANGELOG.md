...
## 0.2.0
***
**♻️Rework of `PAR1xx` ([#22](https://github.com/robsdedude/flake8-picky-parentheses/pull/20))**
...
* Rewrite of the redundant parentheses checker (`PAR1xx`) to increase reliability, stability and performance.
